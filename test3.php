...
<head>
    ...
    <style>
        ...
        /* --- شاشة الدخول الاحترافية: فيديو واقعي عربي (VFX Intro) --- */
        #pro-cinematic-intro {
            position: fixed;
            top: 0; left: 0;
        ...
        /* تأثير الدخان والضوء المتحرك (VFX Background) */
        .video-bg-effect {
            position: absolute;
        ...
        .main-logo-vfx {
            ...
            animation: logoPulsePro 2s infinite ease-in-out;
        }
        ...
        .sub-title-pro {
            ...
            letter-spacing: 5px;
            opacity: 0;
            animation: fadeInPro 1s 1.2s forwards;
            font-family: 'Poppins', sans-serif;
        }

        /* شريط التحميل الرقمي الذكي */
        .loading-frame {
            width: 280px;
            height: 3px;
        ...
        .loading-fill-vfx {
            position: absolute;
            width: 0%; height: 100%;
            background: linear-gradient(to right, transparent, var(--main), #fff);
            box-shadow: 0 0 15px var(--main);
            animation: proLoadingFlow 3.5s cubic-bezier(0.1, 0.5, 0.5, 1) forwards;
        }
        ...
        /* --- الحركات السينمائية (Animations) --- */
        @keyframes moveVFX {
            0% { transform: rotate(0deg) scale(1); }
            100% { transform: rotate(360deg) scale(1.2); }
        }

        @keyframes logoPulsePro {
        ...
        @keyframes proLoadingFlow {
            0% { width: 0%; }
            100% { width: 100%; }
        }

        /* تأثير الخروج السينمائي (Zoom Out & Blur) */
        .intro-finish-vfx {
            transform: scale(1.2);
            filter: blur(20px);
            opacity: 0;
...
<script>
// التحكم في شاشة الدخول (3.5 ثانية)
