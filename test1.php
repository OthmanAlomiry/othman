...
<head>
    ...
    <style>
        :root { 
            --main: #e11d48; 
            --bg-deep: #061626; 
            --purple-grad: linear-gradient(135deg, #6366f1 0%, #a855f7 100%);
            --whatsapp: #25d366; 
            --snapchat: #FFFC00; 
        }
        ...
        /* =======================================================
           تصميم اسم القناة المائل والبنفسجي المطور
           ======================================================= */
        .c-head { 
            padding: 12px 15px; 
        ...
        .channel-name-box {
            background: linear-gradient(45deg, #7c3aed, #fff); /* تدرج بنفسجي وأبيض */
            padding: 6px 20px;
            transform: skew(-15deg); /* حواف مائلة رياضية */
            border-radius: 4px;
        ...
        .channel-name {
            ...
            transform: skew(15deg); /* إرجاع النص للوضع المستقيم داخل المربع المائل */
            font-family: 'Poppins', 'Tajawal', sans-serif;
            font-size: 15px;
            font-weight: 900;
            color: #061626; /* لون النص غامق ليظهر على الأبيض والبنفسجي */
        }
