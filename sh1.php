...
<head>
    ...
    <style>
        ...
        .header-fixed-container { position: fixed; top: 0; left: 0; right: 0; width: 100%; z-index: 1000; background: rgba(5, 12, 20, 0.95); backdrop-filter: blur(25px); border-bottom: 1px solid var(--glass-border); padding: 10px 0; text-align: center; }
...
<div class="grid">
    <div id="section-alkas" class="channel-section">
        <div class="card">
            ...
            <button class="play-btn" onclick="robustPlay('vsh', 'https://liveeu-gcp.alkassdigital.net/shooflive/main.m3u8', this)">تشغيل بث قناة شوف</button>
        </div>
        <?php for($i=1; $i<=7; $i++): ?>
        <div class="card">
