...
<head>
    ...
    <style>
        ...
        /* شريط المباريات عثمان - صغير ومرتب */
        .match-slider { display: flex; gap: 10px; overflow-x: auto; padding: 10px 15px; scrollbar-width: none; background: rgba(255,255,255,0.02); margin-top: 5px; -webkit-overflow-scrolling: touch; }
...
<div class="main-container">
    ...
    <div class="header-fixed">
        ...
        <div class="match-slider">
            ...
            if(!$f_found) echo '<p style="font-size:10px; opacity:0.3; width:100%;">لا توجد مباريات هامة اليوم</p>';
            ?>
        </div>
