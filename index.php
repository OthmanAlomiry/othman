...
// --- إعدادات السحابة الخاصة بك عثمان ---
...
// --- دالة جلب القنوات السحابية المصححة ---
...
<div class="grid">
    <?php 
    $sections = ['bein', 'mbc', 'alkas', 'on', 'ado', 'dubai', 'kuwait', 'star', 'moc', 'sky', 'plus'];
    ...
    <div id="section-<?php echo $sec; ?>" class="channel-section <?php echo ($sec == 'bein' ? 'active' : ''); ?>">
        ...
        <div class="card">
            <div class="c-head">
                <div style="background:linear-gradient(45deg, #0ea5e9, #fff); padding: 5px 15px; border-radius: 10px; font-size: 11px; font-weight: 900; color: #000;"><?php echo $ch['name']; ?></div>
