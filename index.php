...
<head>
    ...
    <script>
      ...
      OneSignal.push(function() {
        OneSignal.init({
          ...
          notifyButton: {
            enable: true,
            displayPredicate: function() { return true; }, // إجبار الجرس على الظهور
    ...
    <style>
        ...
        body { margin: 0; font-family: 'Tajawal', sans-serif; background-color: var(--bg); padding-top: 190px; color: #e2e8f0; overflow-x: hidden; }
        ...
        .subscribe-bar { background: #e11d48; color: white; padding: 8px; font-size: 11px; font-weight: bold; cursor: pointer; border: none; width: 100%; margin-top: 10px; }
        ...
        .play-btn { width: 90%; margin: 15px auto; display: block; background: rgba(255, 255, 255, 0.1); color: #fff; border: 1px solid rgba(255, 255, 255, 0.2); padding: 12px; border-radius: 50px; font-weight: 900; cursor: pointer; }
    </style>
</head>
<body>
...
<div class="header-fixed-container">
    ...
    <button class="subscribe-bar" onclick="forceSubscribe()">
        <i class="fas fa-bell"></i> اضغط هنا لتفعيل التنبيهات (هام جداً)
    </button>

    <div style="display:flex; justify-content:center; gap:10px; margin-top:10px;">
        <a href="https://wa.me/966505571164" style="text-decoration:none; color:#22c55e; font-size:11px; font-weight:bold;"><i class="fab fa-whatsapp"></i> واتساب</a>
        <a href="https://t.me/d_s_pro" style="text-decoration:none; color:#0088cc; font-size:11px; font-weight:bold;"><i class="fab fa-telegram-plane"></i> تليجرام</a>
    </div>
</div>
    ...
    <?php if(isset($manual_channels['custom_matches'])) foreach($manual_channels['custom_matches'] as $cm): ?>
        <div class="m-card">
            ...
            <div style="display:flex; justify-content:space-between; align-items:center;">
                <div style="text-align:center;"><img src="<?php echo $cm['home_logo'] ?: 'https://via.placeholder.com/40'; ?>" width="35" height="35"><br><span style="font-size:9px;"><?php echo $cm['home']; ?></span></div>
                <div style="text-align:center; font-size:12px; font-weight:bold; color:#f1c40f;"><?php echo $cm['time']; ?></div>
                <div style="text-align:center;"><img src="<?php echo $cm['away_logo'] ?: 'https://via.placeholder.com/40'; ?>" width="35" height="35"><br><span style="font-size:9px;"><?php echo $cm['away']; ?></span></div>
            </div>
        </div>
    <?php endforeach; ?>
</div>
