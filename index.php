...
<head>
    ...
    <style>
        ...
        /* تم تقليل المسافة العلوية هنا من 280 بكسل إلى 190 بكسل عثمان */
        body { margin: 0; font-family: 'Tajawal', sans-serif; background-color: var(--bg-deep); padding-top: 190px; color: #e2e8f0; overflow-x: hidden; }
