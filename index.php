...
// دالة فحص الإشعارات عثمان (تم تصحيح السطر 40 هنا)
...
<div class="main-container">
    ...
    <div class="header-fixed">
        ...
        <marquee style="color:#fff; font-size:11px;"><?= $news['text'] ?></marquee>
        <?php endif; ?>
    ...
    <div class="grid">
        ...
        <div id="section-<?= $s['key'] ?>" class="channel-section <?= ($count == 0 ? 'active' : '') ?>" style="<?= ($count == 0 ? 'display:block;' : 'display:none;') ?>">
            ...
            <div class="card">
                <div class="c-head"><div class="name-badge"><?= $ch['name'] ?></div><div style="color:#ff4d4d; font-size:10px; font-weight:900;">مباشر</div></div>
