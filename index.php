...
<head>
    ...
    <style>
        ...
        /* تم تعديل المسافة هنا لتصبح 330px لكي تظهر الكروت تحت الشريط تماماً */
        body { margin: 0; font-family: 'Tajawal', sans-serif; background-color: var(--bg-deep); padding-top: 330px; color: #e2e8f0; overflow-x: hidden; }
