...
<head>
    ...
    <style>
        ...
        .match-scroll { display: flex; gap: 12px; overflow-x: auto; padding-bottom: 10px; scrollbar-width: none; min-height: 140px; }
        .match-scroll::-webkit-scrollbar { display: none; }
        
        /* التنسيق الجديد للكروت داخل fetch_matches */
        .match-card { 
            min-width: 270px; background: var(--glass); border-radius: 20px; padding: 0 15px 15px 15px;
        ...
        .m-league { font-size: 9px; color: #00ff87; font-weight: 800; text-shadow: 0 0 5px rgba(0,255,135,0.5); }
        ...
        .m-footer { border-top: 1px solid var(--glass-border); padding-top: 10px; display: flex; justify-content: space-between; font-size: 9px; }
...
<div class="matches-section">
    ...
    <div class="match-scroll" id="live-matches-container">
        <div style="padding:20px; opacity:0.5;">جاري تحديث النتائج المباشرة...</div>
    </div>
</div>
...
function refreshMatches() {
    fetch('fetch_matches.php?t=' + new Date().getTime())
        ...
        .catch(err => console.log('Matches Sync Error'));
}
