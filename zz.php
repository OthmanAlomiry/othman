...
<head>
    ...
    <style>
        ...
        #pro-cinematic-intro {
            ...
            display: flex; justify-content: center; align-items: center; z-index: 1000000; perspective: 1000px; transition: 1s;
        }
        ...
        .promo-top-text { font-size: 11px; line-height: 1.6; color: #fff; margin-bottom: 10px; max-width: 90%; margin-left: auto; margin-right: auto; font-weight: 700; }
        ...
        .match-card { 
            min-width: 280px; background: rgba(255,255,255,0.03); backdrop-filter: blur(15px); 
            border-radius: 18px; padding: 12px; border: 1px solid rgba(255,255,255,0.08); cursor: pointer;
        }
        ...
        .team-name { font-size: 10px; font-weight: 700; margin-top: 4px; display: block; }
        .score { font-size: 1.3em; font-weight: 900; letter-spacing: 2px; }
        ...
        .play-btn-premium { width: 92%; margin: 12px auto; display: flex; justify-content: center; align-items: center; gap: 8px; background: linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.05)); color: #fff; border: 1px solid rgba(255, 255, 255, 0.2); padding: 12px; border-radius: 50px; font-weight: 900; font-size: 13px; cursor: pointer; }
