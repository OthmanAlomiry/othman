...
<head>
    ...
    <style>
        ...
        .sub-title-pro { font-size: 14px; color: var(--main); font-weight: 700; margin-top: 10px; letter-spacing: 5px; opacity: 0; animation: fadeInPro 1s 1.2s forwards; font-family: 'Poppins', sans-serif; }
        ...
        .status-msg-vfx { font-size: 11px; color: rgba(255,255,255,0.4); letter-spacing: 2px; }
