...
<head>
    ...
    <style>
        ...
        /* --- الهيدر الزجاجي (إصلاح التوسيط) --- */
        .header-fixed-container { 
            position: fixed; top: 0; left: 0; width: 100%; z-index: 1000;
            background: rgba(5, 12, 20, 0.9); backdrop-filter: blur(25px); 
            border-bottom: 1px solid var(--glass-border); padding: 20px 10px;
            box-shadow: 0 10px 30px rgba(0,0,0,0.6);
            display: flex; flex-direction: column; align-items: center; text-align: center;
        }
        .promo-text { 
            font-size: 13px; font-weight: 700; color: #fff; 
            margin-bottom: 15px; line-height: 1.7; width: 95%; max-width: 650px; 
            text-shadow: 0 2px 10px rgba(0,0,0,0.5); margin-inline: auto;
        }
        .social-links { display: flex; justify-content: center; gap: 10px; flex-wrap: wrap; width: 100%; }
