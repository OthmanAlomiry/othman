...
<div class="header-fixed-container">
    ...
    <div class="promo-text">للاشتراك في الباقة كاملة على جميع الأجهزة والشاشات تواصل معنا</div>
        ...
        ?>
                <div class="match-card">
                    ...
                    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:12px;">
                        <div style="flex:1; text-align:center;"><img src="<?php echo $m['homeTeam']['crest']; ?>" width="35" onerror="this.src='https://via.placeholder.com/40'"><span style="font-size:9px; font-weight:700; margin-top:5px; display:block;"><?php echo $hName; ?></span></div>
                        <div style="flex: 1.2; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 5px;">
                            <?php if ($is_live): ?>
                                <div style="display:flex; align-items:center; gap:5px;"><div class="s-box"><?php echo $m['score']['fullTime']['home']; ?></div><span style="font-weight:900; opacity:0.6;">-</span><div class="s-box"><?php echo $m['score']['fullTime']['away']; ?></div></div>
                        ...
                        <div style="flex:1; text-align:center;"><img src="<?php echo $m['awayTeam']['crest']; ?>" width="35" onerror="this.src='https://via.placeholder.com/40'"><span style="font-size:9px; font-weight:700; margin-top:5px; display:block;"><?php echo $aName; ?></span></div>
                    </div>
                </div>
...
<div class="grid">
    <div id="section-bein" class="channel-section active">
        <div style="grid-column: 1/-1; font-size:18px; font-weight:900; border-bottom:1px solid var(--glass-border); padding-bottom:10px;">قنوات beIN Sports</div>
        <?php for($i = 1; $i <= 9; $i++): ?>
        <div class="card">
    ...
    <div id="section-shahad" class="channel-section">
        <div style="grid-column: 1/-1; font-size:18px; font-weight:900; border-bottom:1px solid var(--glass-border); padding-bottom:10px;">باقة شاهد الرياضية</div>
        <div class="card"><div class="c-head"><div class="name-box-blue">شاهد الرياضية 1</div><div class="live-box"><div class="live-dot"></div><span style="font-size:9px; color:#22c55e;">LIVE</span></div></div><video id="vidsh1" playsinline controls></video><button class="play-btn-premium" onclick="robustPlay('vidsh1', 'b13.php', this)">بدء البث</button></div>
        <div class="card"><div class="c-head"><div class="name-box-blue">شاهد الرياضية 2</div><div class="live-box"><div class="live-dot"></div><span style="font-size:9px; color:#22c55e;">LIVE</span></div></div><video id="vidsh2" playsinline controls></video><button class="play-btn-premium" onclick="robustPlay('vidsh2', 'b14.php', this)">بدء البث</button></div>
    </div>

    <div id="section-mbc" class="channel-section">
        <div style="grid-column: 1/-1; font-size:18px; font-weight:900; border-bottom:1px solid var(--glass-border); padding-bottom:10px;">باقة MBC</div>
        <div class="card"><div class="c-head"><div class="name-box-blue">MBC 1</div><div class="live-box"><div class="live-dot"></div><span>LIVE</span></div></div><video id="vmbc1" playsinline controls></video><button class="play-btn-premium" onclick="robustPlay('vmbc1', 'mb1.php', this)">بدء البث</button></div>
        <div class="card"><div class="c-head"><div class="name-box-blue">MBC Action</div><div class="live-box"><div class="live-dot"></div><span>LIVE</span></div></div><video id="vmbca" playsinline controls></video><button class="play-btn-premium" onclick="robustPlay('vmbca', 'b12.php', this)">بدء البث</button></div>
        <div class="card"><div class="c-head"><div class="name-box-blue">MBC مصر 1</div><div class="live-box"><div class="live-dot"></div><span>LIVE</span></div></div><video id="vmbcm1" playsinline controls></video><button class="play-btn-premium" onclick="robustPlay('vmbcm1', 'mbe1.php', this)">بدء البث</button></div>
        <div class="card"><div class="c-head"><div class="name-box-blue">MBC مصر 2</div><div class="live-box"><div class="live-dot"></div><span>LIVE</span></div></div><video id="vmbcm2" playsinline controls></video><button class="play-btn-premium" onclick="robustPlay('vmbcm2', 'mbe2.php', this)">بدء البث</button></div>
    </div>

    <div id="section-alkas" class="channel-section">
        <div style="grid-column: 1/-1; font-size:18px; font-weight:900; border-bottom:1px solid var(--glass-border); padding-bottom:10px;">قنوات الكاس</div>
        <div class="card"><div class="c-head"><div class="name-box-purple">SHOOF LIVE</div><div class="live-box"><div class="live-dot"></div><span>LIVE</span></div></div><video id="vsh" playsinline controls></video><button class="play-btn-premium" onclick="robustPlay('vsh', 'sh1.php', this)">بث قناة شوف</button></div>
        <?php for($i=1; $i<=7; $i++): ?>
        <div class="card">
            <div class="c-head"><div class="name-box-purple">الكاس <?php echo $i; ?></div><div class="live-box"><div class="live-dot"></div><span>LIVE</span></div></div>
            <video id="vkas<?php echo $i; ?>" playsinline controls></video>
            <button class="play-btn-premium" onclick="robustPlay('vkas<?php echo $i; ?>', 'k<?php echo $i; ?>.php', this)">بدء البث</button>
        </div>
        <?php endfor; ?>
    </div>
</div>
