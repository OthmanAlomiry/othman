...
<head>
    ...
    <style>
        ...
        /* تنسيق صور الشعارات */
        .cat-item img { height: 35px; width: auto; object-fit: contain; }
...
<div class="header-fixed-container">
    ...
    <div class="category-tabs">
        <div class="cat-item" onclick="switchSection('bein', this)">
            <img src="[attachment_0](attachment)" alt="beIN Sports">
            <span>beIN Sports</span>
        </div>
        <div class="cat-item" onclick="switchSection('shahid', this)">
            <img src="[attachment_2](attachment)" alt="SHAHID">
            <span>SHAHID</span>
        </div>
        <div class="cat-item" onclick="switchSection('mbc', this)">
            <img src="[attachment_3](attachment)" alt="MBC">
            <span>MBC TV</span>
        </div>
        <div class="cat-item" onclick="switchSection('starz', this)">
            <img src="[attachment_1](attachment)" alt="STARZPLAY">
            <span>STARZPLAY</span>
        </div>
    </div>
</div>
